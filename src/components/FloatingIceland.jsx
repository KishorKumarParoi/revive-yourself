...
Source: https://sketchfab.com/3d-models/interdimensional-floating-islands-0742e636aa9a40b5865436511e3595cf
Title: Interdimensional Floating Islands
*/

import React, { useRef } from 'react'
import { useGLTF, useAnimations } from '@react-three/drei'

export default function FloatingIceland(props) {
    const group = useRef()
    const { nodes, materials, animations, scene } = useGLTF('/Floating-Island/scene.gltf')
...
useGLTF.preload('/Floating-Island/scene.gltf')
